...
A simple C++ program that converts time between **seconds** and **HH:MM:SS** format using a class and menu-driven approach.
...
The program provides two conversion options:
...
![Q1 Output](TIme-Converter/output/q1.jpg)
